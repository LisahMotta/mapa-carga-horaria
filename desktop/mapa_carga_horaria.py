...
Aplicativo desktop nativo (Tkinter) — ANEXO III · SEDUC / CGRH / CEVIF.
...
class MapaApp(ttk.Frame):
    ...
    def _construir(self):
        ...
        ttk.Label(
            head, text="ANEXO III · SEDUC / CGRH / CEVIF — cálculo de proventos",
...
<div class='map'>
<div class='hd'><h3>Mapa de Carga Horária</h3><small>ANEXO III · SEDUC / CGRH / CEVIF — cálculo de proventos</small></div>
